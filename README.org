...
Organize my travel log. Edit with =org-mode=, store in Git and render via [[https://help.github.com/articles/mapping-geojson-files-on-github/][GitHub
geoJSON]].
...
*** Usage
    ...
    all the blocks. The editable travel log appears after first block has
    have been executed.
